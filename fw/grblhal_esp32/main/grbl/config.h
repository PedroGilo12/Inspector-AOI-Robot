 ...
 */
#ifndef N_AXIS
#define N_AXIS 5 // X Y Z + A B (roll/pitch). Yaw (C) dropped: robot cannot yaw; TinyBee has 2 spare axes.
#endif
...
#define DEFAULT_STEPPER_IDLE_LOCK_TIME 255 // milliseconds (255 = steppers stay energized, never disable)
#endif
///@}
